package zomatogroup.config

import zomatogroup.common.constant.SpringProfile
...
@PropertySource('file:${SPRING_BOOT_PROPERTIES_DIR}/biryani.properties')
class SecondaryDataSourceLocalConfig extends SecondaryDataSourceAbstractConfig {
    ...
    SecondaryDataSourceLocalConfig() {
        ...
        assert Files.exists(Paths.get("${dir}/biryani.properties")),
                "${dir}/biryani.properties containing externalized datasource properties must exist"
    }
